...
These $\alpha$ values can be used to form a hueristic for comparing multiple labels $L_{1},L_{2},\dots$ which have differening balances of between and within-cluster dissimilarities.
To compare $H_{+,1},H_{+,2}$ induced using two labels $L_{1},L_{2}$, we suggest scaling one label to the $\alpha$ balance of the other: $H_{+,2}'= H_{+,2} \cdot \frac{\alpha_{2}(1-\alpha{2})}{\alpha_{1}(1-\alpha{1})}$.
