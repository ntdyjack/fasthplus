...
In this way, we explore how $H_{+}$ behaves in the case where a cluster set $L$ has not provided any more information than we might attain by chance.
...
In this way, we explore how $H_{+}$ behaves in the case where a cluster set $L$ gives more information that we might attain by chance
